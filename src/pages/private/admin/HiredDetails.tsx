...
export default function HiredDetails() {
    ...
    return (
        <div className="p-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white border border-gray-200 rounded-xl shadow-lg p-8 relative">
                ...
                <h1 className="text-3xl font-bold text-gray-800 mb-6">Hired Details</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 p-4 bg-[#FFFFFF] gap-4">
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="space-y-4 text-base text-gray-700">
                            ...
                            {/* Add Status Below Education */}
                            <p>
                                <span className="font-medium">Status:</span>
                                <span className="bg-white text-pink-600 border border-pink-600 px-4 py-2 rounded-sm text-sm font-medium">
                                    {applicant.status}
                                </span>
                            </p>
                        </div>
...
{user.info.userType !== "hr" ? (
    <div className="flex justify-end space-x-4 -t border-gray-300">
        ...
        <Button
            disabled={isUpdating}
            className={`${applicant.status === "HIRED"
                ? "bg-white text-pink-500 border border-pink-500"
                : "bg-pink-500 text-white"
                }`}
            onClick={() => handleApplicantStatusChange("HIRED")}
        >
            Hire
        </Button>
    </div>
